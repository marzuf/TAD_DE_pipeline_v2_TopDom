startTime <- Sys.time()
cat(paste0("> Rscript cmp_DE_TADs_genes_GOsignif_pvalSelect.R\n"))

# Rscript cmp_DE_TADs_genes_GOsignif_pvalSelect.R
...
outFold <- "CMP_TADs_GENES_GO_SIGNIF_pvalSelect"
system(paste0("mkdir -p ", outFold))

logFile <- file.path(outFold, "cmp_tads_genes_go_signif_pvalSelect_logFile.txt")
