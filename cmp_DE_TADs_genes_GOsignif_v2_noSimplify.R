cat(paste0("> Rscript cmp_DE_TADs_genes_GOsignif_v2_noSimplify.R\n"))

# Rscript cmp_DE_TADs_genes_GOsignif_v2_noSimplify.R
...
outFold <- file.path("CMP_TADs_GENES_GO_SIGNIF_v2_NO_SIMPLIFY", enrichGO_ont)
system(paste0("mkdir -p ", outFold))

logFile <- file.path(outFold, "cmp_tads_genes_go_signif_v2_noSimplify_logFile.txt")
