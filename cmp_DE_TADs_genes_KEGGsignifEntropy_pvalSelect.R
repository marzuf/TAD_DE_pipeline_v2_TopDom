startTime <- Sys.time()
cat(paste0("> Rscript cmp_DE_TADs_genes_KEGGsignifEntropy_pvalSelect.R\n"))

# Rscript cmp_DE_TADs_genes_KEGGsignifEntropy_pvalSelect.R
...
outFold <- "CMP_TADs_GENES_KEGG_SIGNIF_ENTROPY_pvalSelect"
system(paste0("mkdir -p ", outFold))

logFile <- file.path(outFold, "cmp_tads_genes_kegg_signif_entropy_pvalSelect_logFile.txt")
